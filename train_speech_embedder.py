...
def train(model_path):
    ...
    train_dataset = KefuDataset(hp.data.train_path_json, hp.train.M)
...
def test(model):
    ...
    test_dataset = KefuDataset(hp.data.test_path_json, hp.test.M)
...
if __name__=="__main__":
    if hp.training:
        ...
        for i in glob.glob("./speech_id_checkpoint_200h_10_1024.256_0.01/ckpt*"):
            test(i)
